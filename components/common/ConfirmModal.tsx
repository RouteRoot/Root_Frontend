...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/20 px-4">
      <div className="w-full max-w-[320px] overflow-hidden rounded-[22px] border border-[#E8EDF5] bg-white shadow-[0_20px_60px_rgba(15,23,42,0.12)]">
        ...
        <div className="px-5 py-5">
          ...
          <div className="mt-6 flex justify-end gap-3">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={loading}
              className="inline-flex h-[40px] items-center justify-center rounded-[12px] bg-[#6D5DF6] px-4 text-[13px] font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
            >
