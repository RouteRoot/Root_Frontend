        ...
        <section className="grid grid-cols-1 gap-5 xl:grid-cols-3">
          ...
          <div className="rounded-[28px] border border-[#E8E8E5] bg-white p-6 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            ...
            <div className="mt-4">
              {todayPlans.length > 0 ? (
                <>
                  <div className="mb-4 rounded-2xl bg-neutral-50 px-4 py-3">
                    <p className="text-sm text-neutral-500">오늘 진행 상황</p>
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-2xl border p-5 transition-all duration-300 ${
                          day.isCompleted
                            ? "scale-[1.01] border-black bg-black text-white shadow-[0_8px_24px_rgba(0,0,0,0.16)]"
